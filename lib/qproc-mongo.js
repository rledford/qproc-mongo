  ...
  return {
    ...
    exec: function (q) {
      ...
      if (q[projKey]) {
        ...
        qproc.info.projCount = pKeys.length;
      ...
      if (q[searchKey]) {
        ...
        if (searchFields.length) {
          qproc.info.fieldCount = searchFields.length;
          qproc.filter = {
            $or: searchFields
          };
        } else {
          ...
          if (isNin || isAll) {
            ...
            if (resolvedField.type === types.String) {
              ...
              try {
                ...
                qproc.info.regexCount++;
                qproc.info.regexList.push(value);
              } catch (unused) {}
            }
          } else {
